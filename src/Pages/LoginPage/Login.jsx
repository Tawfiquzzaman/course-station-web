        ...
        <div className="card bg-[#D1D8BE] w-full max-w-sm shrink-0 shadow-2xl">
          ...
          <div className="card-body">
            <form className="fieldset" onSubmit={handleLogin}>
              ...
              {/* Google */}
              <button onClick={handleGoogleSignIn} className="btn bg-white hover:bg-black hover:text-white text-black border-[#e5e5e5] rounded-full cursor-pointer">
                <svg
              ...
              {/* Github login button */}
              <button onClick={handleGithubSignIn} className="btn bg-black hover:bg-white hover:text-black text-white border-black rounded-full">
